...
class ITSASInput extends ITSASElement {
    ...
    get #icon() {
        return html`
            <itsas-icon class="icon" icon="{}" name="lock" fill="${this.fill}" size="${this.size}" scale="1" rotate="0" speed="0" blink="0" blval="1;0;0;1" path=""></itsas-icon>
        `
    }
    ...
    get #button() {
        return html`
            <itsas-icon class="button" icon="{}" name="eye-regular" fill="${this.fill}" size="${this.size}" scale="1" rotate="0" speed="0" blink="0" blval="1;0;0;1" path="" @click=${this.updateLoginValue}></itsas-icon>
        `
    }
    get #button1() {
        return html`
