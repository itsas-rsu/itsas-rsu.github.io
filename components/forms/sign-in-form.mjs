            ...
            <form class="form animate" method="post" id="form">
                ...
                <div class="form-body">
                    <div id="db-tab-section" class="form-tab-section selected">
                        <itsas-input id="login" type="text" name="user" placeholder="Login" icon="{}" class="notoggled" fill="gray" size="20" scale="0.9" rotate="0" speed="0" blink="0" blval="1;0;0;1" path=""></itsas-input>
                        <itsas-password id="password" type="Password" placeholder="Password" visibleIcon="eye-slash-regular" invisibleIcon="eye-regular" class="notoggled" icon="{}" name="lock" fill="gray" size="20" scale="0.9" rotate="0" speed="0" blink="0" blval="1;0;0;1" path=""></itsas-password>
