        ...
        render() {
            return html`
                <div>
                    ...
                    ${!this.isModified ? html`<simple-button padding="11px 21.5px" label="Обучить" @click=${this.LearnModel}></simple-button>` : ""}
                    ${!this.isModified ? html`<simple-button padding="11px 21.5px" label="Предсказать" @click=${this.PredictModel}></simple-button>` : ""}
                </div>
            `;
        }
